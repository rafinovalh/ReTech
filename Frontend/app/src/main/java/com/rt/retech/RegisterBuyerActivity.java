...
public class RegisterBuyerActivity extends AppCompatActivity {
    ...
    protected void requestRegisterBuyer(){
        mApiService.registerRequestBuyer(username.getText().toString(), password.getText().toString(), email.getText().toString(), Integer.getInteger(phone.getText().toString())).enqueue(new Callback<ResponseBody>() {
            @Override
