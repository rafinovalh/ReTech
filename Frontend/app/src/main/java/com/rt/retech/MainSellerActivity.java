...
public class MainSellerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listProducts.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent move = new Intent(mContext, ProductDetailSellerActivity.class);
                startActivity(move);
            }
        });
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent move = new Intent(MainSellerActivity.this, AddProductActivity.class);
                startActivity(move);
            }
        });
    }
    ...
    void requestList(){
        Gson gson = new Gson();
        mApiService.showProductSellerRequest(MainSellerActivity.selectedProducts.getSeller_id()).enqueue(new Callback<ResponseBody>() {
            @Override
